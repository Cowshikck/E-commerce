...
const firebaseConfig = {
    apiKey: "AIzaSyDQz_TiDNBkUqhEiNlI06_4ui2UnEwRVyo",
    authDomain: "e-commerce-website-e4336.firebaseapp.com",
    projectId: "e-commerce-website-e4336",
    storageBucket: "e-commerce-website-e4336.firebasestorage.app",
    messagingSenderId: "694327218210",
    appId: "1:694327218210:web:6b64eef9db8defce50ba7b",
    measurement: "G-18R09V7RN6"
  };
...
//   });
  ...
  auth.onAuthStateChanged(user => {
    ...
    if (user) {
        ...
        if (user.email !== "cowshik@gmail.com") {
            auth.signOut().then(() => {
      ...
      query.get()
          .then(snapshot => {
              ...
              if (!downloadBtn) {
                  ...
                  downloadBtn.type = 'submit';  // Set type to submit
                  downloadBtn.style.marginTop = '20px';
                  downloadBtn.classList.add('download-btn'); // Add CSS class
